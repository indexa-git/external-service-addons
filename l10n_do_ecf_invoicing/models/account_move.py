...
class AccountMove(models.Model):
    ...
    def _get_IdDoc_data(self):
        ...
        if l10n_do_ncf_type not in ("32", "34") and self.l10n_do_ncf_expiration_date:
    ...
    def _get_Comprador_data(self):
        ...
        if l10n_do_ncf_type not in ("43", "47"):
            ...
            if partner_vat and l10n_do_ncf_type == "32" and is_l10n_do_partner:
                buyer_data["RNCComprador"] = partner_vat
    ...
    def _get_Totales_data(self):
        ...
        if l10n_do_ncf_type not in ("43", "44"):
            ...
            if tax_data["isr_withholding_amount"] or l10n_do_ncf_type in ("47", "41"):
    ...
    def _get_Item_list(self, ecf_object_data):
        ...
        for i, line in enumerate(
            ...
            line_dict["CantidadItem"] = ("%.2f" % line.quantity).rstrip("0").rstrip(".")
